...
export const tripSchema = z
	.array(
		z.object({
			...
			startedAt: z.int().min(-9_007_199_254_740_991).max(9_007_199_254_740_991).nullable(),
			endedAt: z.int().min(-9_007_199_254_740_991).max(9_007_199_254_740_991).nullable(),
		})
	)
	.min(1)
	.max(50);
