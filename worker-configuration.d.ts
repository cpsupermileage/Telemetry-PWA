/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 3805272cfd7d7dfd0e5709699caa6ed4)
// Runtime types generated with workerd@1.20260212.0 2026-02-13 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./server/index');
		durableNamespaces: 'TripsDataServer' | 'TelemetryDataServer';
	}
	interface Env {
		PUBLIC_GOOGLE_MAPS_API_KEY: string;
		TRIPS_DATA_SERVER: DurableObjectNamespace /* TripsDataServer */;
		TELEMETRY_DATA_SERVER: DurableObjectNamespace /* TelemetryDataServer */;
	}
}
