/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 93f2fbf79fe19d8df1fd7103418348a1)
// Runtime types generated with workerd@1.20260212.0 2026-02-13 nodejs_compat
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import('./server/index');
		durableNamespaces: 'WebSocketBroadcastServer';
	}
	interface Env {
		DB: D1Database;
		...
		BROADCAST_SERVER: DurableObjectNamespace /* WebSocketBroadcastServer */;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<
		Pick<
			Cloudflare.Env,
			'PUBLIC_GOOGLE_MAPS_API_KEY' | 'CLOUDFLARE_ACCOUNT_ID' | 'CLOUDFLARE_DATABASE_ID' | 'CLOUDFLARE_D1_TOKEN'
		>
	> {}
}
